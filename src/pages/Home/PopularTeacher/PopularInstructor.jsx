        ...
        <>
          <div className="grid mb-28 md:grid-cols-2 lg:grid-cols-4 mx-auto w-[90%] gap-6 ">
            {instructors?.map((instructor, i) => (
              <div
                key={i}
                className="flex dark:text-white hover:-translate-y-2 duration-200 border  border-secondary cursor-pointer flex-col shadow-md py-8 px-10 md:px-8 rounded-md"
              >
                <div className="flex flex-col gap-6 md:gap-8">
                  ...
                  Instructor
                    ...
                    <div className="text-gray-500 mb-4 whitespace-wrap">
