  ...
  return (
    <>
      ...
      >
        ...
        <div className="breadcrumbs  py-10 mt-10 section-padding bg-cover bg-center bg-no-repeat">
          <div className="container text-center">
            <h2 className="text-2xl font-bold text-center">Course Details</h2>
          </div>
        </div>
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <p className="mt-4">
                              ...
                              temporibus architecto hic reprehenderit ducimus
