...
const Footer = () => {
  ...
  const notify = () => {
    if (validateEmail(email)) {
      toast.success("You are Subscribed!", { theme: "colored" });
      setEmail("");
    } else {
    ...
    <footer aria-label="Site Footer" className="bg-white dark:bg-black">
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-md">
          <strong className="block dark:text-white text-center text-xl font-bold text-gray-900 sm:text-3xl">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
          <div className="mx-auto max-w-sm lg:max-w-none">
            <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">
              ...
              lessons, helping you develop a solid foundation while nurturing
          ...
          <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
            <div>
              <strong className="font-bold dark:text-white text-gray-900">
                {" "}
                Services{" "}
              </strong>
            ...
            <div>
              <strong className=" dark:text-white font-bold text-gray-900">
                {" "}
                Support{" "}
              </strong>
        ...
        <div className="mt-16 border-t border-gray-100 pt-8">
          <p className="text-center text-xs/relaxed text-gray-500">
            ...
            <br />
            Created with &nbsp;
            <a className="text-secondary dark: underline transition hover:text-secondary dark:/75">
              Yoga Master
            </a>
          </p>
        </div>
